...
def main():
    # 取得したい動画のURLを指定してください
    video_url = 'https://www.youtube.com/watch?v=f7-Y2Uh_zyk'
    ...
    user_data = {
        ...
        "user_download_date_time": datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
        "user_notes": "",
        "user_tags": [],
    }
    ...
    try:
        ...
        print(f"情報が {json_filename} に保存されました。")
    except IOError as e:
